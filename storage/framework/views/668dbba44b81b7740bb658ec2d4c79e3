    ...
    <header id="topnav" class="navbar navbar-default navbar-fixed-top" role="banner">
        ...
        <div class="logo-area">
            <a class="navbar-brand navbar-brand-primary" href=".">
                <?php echo HTML::image('img/mendikbud_2_icon.png', 'Paper', ['class' => 'show-on-collapse img-logo-white','style'=>'width: 70px;height: 55px;margin-top:4px;margin-left: -15px;']); ?>

                <?php echo HTML::image('img/logo-icon-dark.png', 'Paper', ['class' => 'show-on-collapse img-logo-dark']); ?>

                <?php echo HTML::image('img/mendikbud_2.png', 'Paper', ['class' => 'img-white','style' => 'width: 240px;height: 45px;margin-top:10px;']); ?>

                <?php echo HTML::image('img/logo-dark.png', 'Paper', ['class' => 'img-dark']); ?>
                    ...
                    <div class="scroll-pane">
                        <ul class="media-list scroll-content">
                            ...
                            <li class="media notification-message">
                                <a href="#">
                                    <div class="media-left">
                                        <?php echo HTML::image('demo/avatar/avatar_09.png', '', ['class' => 'img-circle avatar']); ?>
                            ...
                            <li class="media notification-message">
                                <a href="#">
                                    <div class="media-left">
                                        <?php echo HTML::image('demo/avatar/avatar_05.png', '', ['class' => 'img-circle avatar']); ?>

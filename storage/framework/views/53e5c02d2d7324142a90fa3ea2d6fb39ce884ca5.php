<div class="widget">
    ...
    <div class="widget-body">
        <div class="form-group is-empty" style="margin-top: -25px;">
            ...
            <input type="text" value="<?php echo date('Y-m-d'); ?>" id="application-date" class="form-control">
            <span class="material-input"></span>
        </div>
        <div class="form-group is-empty" style="margin-top: -20px;">
            <label class="control-label" for="focusedinput">Report Date</label>
            <input type="text"  value="<?php echo date('Y-m-d'); ?>" id="report-date" class="form-control">
            <span class="material-input"></span>
        </div>
        <div class="col-md-12">

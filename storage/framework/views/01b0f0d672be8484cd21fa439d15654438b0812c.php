...
<link rel="shortcut icon" href="<?php echo asset('img/mendikbud.png'); ?>">

<?php /*Remove google apis font + icon dependency to local resources*/ ?>
<?php /*<link type='text/css' href='css/css?family=Roboto:300,400,400italic,500' rel='stylesheet'>*/ ?>
<?php /*<link type='text/css'  href="css/icon?family=Material+Icons"  rel="stylesheet">*/ ?>
...
<?php echo HTML::style('plugins/pines-notify/pnotify.css'); ?>


<?php echo HTML::style('plugins/sweetalert/sweetalert.css'); ?>
...
<?php echo HTML::style('plugins/form-select2/select2.css'); ?>

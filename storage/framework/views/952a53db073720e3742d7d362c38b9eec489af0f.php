            ...
            <div class="infobar scroll-content">
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="tab-7-2">
                        <?php echo $__env->make('template.sidebar-settings', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="tab-pane active" id="tab-7-1">
                        <?php echo $__env->make('template.sidebar-profile', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>

...
<?php echo FORM::open(['page' => 'lembaga/save', 'class'=>'', 'method'=>'post', 'id'=>'validate-form', 'data-parsley-validate']); ?>
...
<div class="col-md-6">
    ...
    <?php echo $Form->title(trans('register-lembaga.city'))->name('city')->attr('')->id('city')->data($cityLOV)->combobox(); ?>

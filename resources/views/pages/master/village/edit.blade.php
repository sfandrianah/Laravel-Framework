...
{!! FORM::open(['page' => 'village/update', 'class'=>'form-horizontal', 'method'=>'post', 'id'=>'validate-form', 'data-parsley-validate']) !!}
    ...
    {!!$Form->title(trans('master-village.district'))->id('combobox')->name('mda_district_id')->data($districtLOV)->value($value->mda_district_id)->combobox() !!}

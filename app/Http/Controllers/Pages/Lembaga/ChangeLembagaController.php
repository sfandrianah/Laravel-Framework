...
class ChangeLembagaController extends ABaseScaffolding {
    ...
    public function __construct() {
        ...
        $this->lastPageBreadCrumb = PageURLConstant::$CHANGE_LEMBAGA;
...
//        $this->apiEdit = env(IApplicationConstant::PIP_URL_REST) . IApplicationConstant::API_MASTER_PROVINCE_EDIT;
        $this->apiList = env(IApplicationConstant::PIP_URL_REST) . IApplicationConstant::API_CHANGE_LEMBAGA_LIST;
        $this->apiDelete = env(IApplicationConstant::PIP_URL_REST) . IApplicationConstant::API_MASTER_PROVINCE_DELETE;
        $this->apiInsert = env(IApplicationConstant::PIP_URL_REST) . IApplicationConstant::API_CHANGE_LEMBAGA_SAVE;
    }

    public function getIndexPage() {
        return IApplicationConstant::CHANGE_LEMBAGA_INDEX_PAGE;
    }

    public function getNewPage() {
        return IApplicationConstant::CHANGE_LEMBAGA_NEW_PAGE;
    }
    ...
    public function getListPage() {
        return IApplicationConstant::CHANGE_LEMBAGA_LIST_PAGE;
    }

    public function save() {
        $rs = new PIPRestClient();
        $url = env(IApplicationConstant::PIP_URL_REST) . IApplicationConstant::API_CHANGE_LEMBAGA_SAVE;
        $body = array(
